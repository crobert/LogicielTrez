<form name="nouvel_categorie" id="nouvel_categorie" class="" action="<?php echo site_url().'categorie/add/'.$id_budget;?>" method="post" enctype="multipart/form-data" style="padding:0; border:none;">
