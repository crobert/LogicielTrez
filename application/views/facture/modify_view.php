...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" id="methode_paiement" placeholder="Methode paiement" name="methode_paiement" value="<?php echo set_value('methode_paiement', $facture->methode_paiement);?>" required />
    </div>
</div>
<div class="control-group">
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" id="commentaire" placeholder="Commentaire" name="commentaire" value="<?php echo set_value('commentaire', $facture->commentaire);?>" />
    </div>
</div>
<div class="control-group">
