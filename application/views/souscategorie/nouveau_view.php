<form name="nouvelle_souscategorie" id="nouvelle_souscategorie" class="" action="<?php echo site_url().'souscategorie/add/'.$id_categorie;?>" method="post" enctype="multipart/form-data" style="padding:0; border:none;">
	...
	<input type="submit" class="btn" value="Créer sous categorie"/>
</form>
