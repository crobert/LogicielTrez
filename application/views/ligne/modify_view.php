<h1>Modifier la ligne <?php echo $ligne->nom; ?></h1>

<?php echo validation_errors(); ?>

<?php echo form_open('ligne/modify/'.$ligne->id.'/'.$id_souscategorie, array('class' => 'form-horizontal')); ?>
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" id="description" placeholder="Description de la ligne" name="description" value="<?php echo set_value('description', $ligne->description); ?>" required />
    </div>
</div>
<div class="control-group">
