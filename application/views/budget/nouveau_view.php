<form name="nouvel_exercice" id="nouvel_exercice" class="" action="<?php echo site_url();?>budget/add" method="post" enctype="multipart/form-data" style="padding:0; border:none;">
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td width="5">&nbsp;</td>
			<td colspan="5" valign="top">
				<input class="" type="number" name="id_exercice" id="id_exercice" value="<?php echo set_value('id_exercice');?>" style="width:300px; min-width:300px; max-width:300px;" />
				</td>
