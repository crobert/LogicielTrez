<form name="nouvel_exercice" id="nouvel_exercice" class="" action="<?php echo site_url().'budget/modify/'.$budget->id.'/'.$id_exercice;?>" method="post" enctype="multipart/form-data" style="padding:0; border:none;">
